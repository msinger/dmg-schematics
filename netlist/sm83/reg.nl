...
cell reg_and:and_reg rot0 @-236.78,23.50,-232.06,28.09 ->reg;

cell reg_oa1:oa_reg rot180,flip @-198.91,23.63,-193.41,28.00                   ->reg;
cell reg_oa2:oa_reg rot0        @-211.03,23.59,-205.41,28.09 in1@-210.31,28.09 ->reg;

cell reg_nor2_inv:nor2_inv_reg rot0 @-143.25,112.91,-137.66,119.75 ->reg;
...
cell inv_ir_wr:inv_reg_wr    rot0 @-143.16,35.14,-140.41,41.62 in@-143.16,36.61 in@-140.84,37.91 ->reg-ir;
cell reg_ir[0]:dff_reg_bit_b rot0 @-149.95,35.25,-143.13,41.52 ->reg-ir;
cell reg_ir[1]:dff_reg_bit_b rot0 @-161.84,35.25,-155.02,41.53 ->reg-ir;
cell reg_ir[2]:dff_reg_bit_b rot0 @-173.66,35.25,-166.88,41.50 ->reg-ir;
cell reg_ir[3]:dff_reg_bit_b rot0 @-185.55,35.28,-178.75,41.53 ->reg-ir;
cell reg_ir[4]:dff_reg_bit_b rot0 @-197.81,35.31,-191.05,41.59 ->reg-ir;
cell reg_ir[5]:dff_reg_bit_b rot0 @-210.02,35.31,-203.28,41.59 ->reg-ir;
cell reg_ir[6]:dff_reg_bit_b rot0 @-222.28,35.31,-215.50,41.59 ->reg-ir;
cell reg_ir[7]:dff_reg_bit_b rot0 @-234.56,35.32,-227.72,41.60 ->reg-ir;

# Register A
cell inv_a_wr:inv_reg_a_wr  rot0 @-143.16,43.98,-140.38,50.53 ->reg-a;
cell reg_a[0]:dff_reg_bit_b rot0 @-149.97,44.06,-143.19,50.48 ->reg-a;
cell reg_a[1]:dff_reg_bit_b rot0 @-161.88,44.08,-155.08,50.44 ->reg-a;
cell reg_a[2]:dff_reg_bit_b rot0 @-173.64,44.13,-166.88,50.44 ->reg-a;
cell reg_a[3]:dff_reg_bit_b rot0 @-185.56,44.16,-178.77,50.41 ->reg-a;
cell reg_a[4]:dff_reg_bit_b rot0 @-197.80,44.14,-191.00,50.52 ->reg-a;
cell reg_a[5]:dff_reg_bit_b rot0 @-210.02,44.14,-203.28,50.48 ->reg-a;
cell reg_a[6]:dff_reg_bit_b rot0 @-222.30,44.17,-215.50,50.48 ->reg-a;
cell reg_a[7]:dff_reg_bit_b rot0 @-234.58,44.19,-227.77,50.56 ->reg-a;
...
# Register HL
cell inv_l_wr:inv_reg_l_wr    rot0,flip @-143.27,49.84,-140.36,56.14                 ->reg-hl;
cell inv_h_wr:inv_reg_h_e_wr  rot0      @-143.25,61.50,-140.38,67.66                 ->reg-hl;
cell reg_l[0]:dff_reg_bit_a   rot0,flip @-149.98,49.86,-143.17,56.30 d@-149.41,54.13 ->reg-hl;
cell reg_l[1]:dff_reg_bit_a   rot0,flip @-161.81,49.83,-155.00,56.19 d@-161.34,54.13 ->reg-hl;
cell reg_l[2]:dff_reg_bit_a   rot0,flip @-173.70,49.89,-166.89,56.23 d@-173.25,54.16 ->reg-hl;
cell reg_l[3]:dff_reg_bit_a   rot0,flip @-185.56,49.88,-178.73,56.25 d@-185.09,54.19 ->reg-hl;
cell reg_l[4]:dff_reg_bit_a   rot0,flip @-197.80,49.89,-191.02,56.28 d@-197.34,54.22 ->reg-hl;
cell reg_l[5]:dff_reg_bit_a   rot0,flip @-210.05,49.89,-203.25,56.25 d@-209.56,54.22 ->reg-hl;
cell reg_l[6]:dff_reg_bit_a   rot0,flip @-222.33,49.86,-215.48,56.30 d@-221.81,54.19 ->reg-hl;
cell reg_l[7]:dff_reg_bit_a   rot0,flip @-234.53,49.92,-227.72,56.28 d@-234.06,54.22 ->reg-hl;
...
cell reg_h[0]:dff_reg_bit_a   rot0      @-149.94,61.50,-143.13,67.75                 ->reg-hl;
cell reg_h[1]:dff_reg_bit_a   rot0      @-161.84,61.50,-155.09,67.72                 ->reg-hl;
cell reg_h[2]:dff_reg_bit_a   rot0      @-173.75,61.56,-167.03,67.78                 ->reg-hl;
cell reg_h[3]:dff_reg_bit_a   rot0      @-185.66,61.53,-178.91,67.78                 ->reg-hl;
cell reg_h[4]:dff_reg_bit_a   rot0      @-197.91,61.53,-191.13,67.81                 ->reg-hl;
cell reg_h[5]:dff_reg_bit_a   rot0      @-210.09,61.53,-203.38,67.81                 ->reg-hl;
cell reg_h[6]:dff_reg_bit_a   rot0      @-222.38,61.56,-215.53,67.75                 ->reg-hl;
cell reg_h[7]:dff_reg_bit_a   rot0      @-234.56,61.56,-227.69,67.81                 ->reg-hl;

# Register DE
cell inv_e_wr:inv_reg_h_e_wr  rot0,flip @-143.28,67.13,-140.41,73.34                 ->reg-de;
cell inv_d_wr:inv_reg_wr      rot0      @-143.28,78.09,-140.31,84.47                 ->reg-de;
cell reg_e[0]:dff_reg_bit_a   rot0,flip @-150.00,67.13,-143.13,73.38 d@-149.41,71.59 ->reg-de;
cell reg_e[1]:dff_reg_bit_a   rot0,flip @-161.84,67.09,-155.06,73.38 d@-161.31,71.59 ->reg-de;
cell reg_e[2]:dff_reg_bit_a   rot0,flip @-173.78,67.16,-166.94,73.34 d@-173.22,71.63 ->reg-de;
cell reg_e[3]:dff_reg_bit_a   rot0,flip @-185.66,67.22,-178.84,73.41 d@-185.09,71.63 ->reg-de;
cell reg_e[4]:dff_reg_bit_a   rot0,flip @-197.88,67.22,-191.06,73.44 d@-197.34,71.66 ->reg-de;
cell reg_e[5]:dff_reg_bit_a   rot0,flip @-210.09,67.19,-203.38,73.44 d@-209.56,71.63 ->reg-de;
cell reg_e[6]:dff_reg_bit_a   rot0,flip @-222.38,67.22,-215.59,73.38 d@-221.84,71.63 ->reg-de;
cell reg_e[7]:dff_reg_bit_a   rot0,flip @-234.63,67.22,-227.75,73.44 d@-234.06,71.66 ->reg-de;
...
cell reg_d[0]:dff_reg_bit_a   rot0      @-150.00,78.25,-143.13,84.56                 ->reg-de;
cell reg_d[1]:dff_reg_bit_a   rot0      @-161.91,78.28,-155.06,84.47                 ->reg-de;
cell reg_d[2]:dff_reg_bit_a   rot0      @-173.78,78.28,-166.94,84.50                 ->reg-de;
cell reg_d[3]:dff_reg_bit_a   rot0      @-185.63,78.31,-178.81,84.56                 ->reg-de;
cell reg_d[4]:dff_reg_bit_a   rot0      @-197.88,78.34,-191.06,84.53                 ->reg-de;
cell reg_d[5]:dff_reg_bit_a   rot0      @-210.16,78.25,-203.34,84.56                 ->reg-de;
cell reg_d[6]:dff_reg_bit_a   rot0      @-222.34,78.31,-215.59,84.53                 ->reg-de;
cell reg_d[7]:dff_reg_bit_a   rot0      @-234.59,78.31,-227.69,84.59                 ->reg-de;
...
cell reg_c[3]:dff_reg_bit_a   rot0,flip @-185.59,83.94,-178.78,90.19  d@-185.09,88.41 ->reg-bc;
cell reg_c[4]:dff_reg_bit_a   rot0,flip @-197.88,84.00,-191.06,90.22  d@-197.25,88.44 ->reg-bc;
cell reg_c[5]:dff_reg_bit_a   rot0,flip @-210.13,83.94,-203.31,90.22  d@-209.56,88.34 ->reg-bc;
cell reg_c[6]:dff_reg_bit_a   rot0,flip @-222.38,83.94,-215.50,90.16  d@-221.78,88.38 ->reg-bc;
cell reg_c[7]:dff_reg_bit_a   rot0,flip @-234.63,83.97,-227.72,90.22  d@-234.03,88.41 ->reg-bc;
...
cell reg_b[0]:dff_reg_bit_a   rot0      @-149.97,93.91,-143.13,100.22                 ->reg-bc;
cell reg_b[1]:dff_reg_bit_a   rot0      @-161.84,93.94,-155.09,100.19                 ->reg-bc;
cell reg_b[2]:dff_reg_bit_a   rot0      @-173.75,93.97,-166.94,100.19                 ->reg-bc;
cell reg_b[3]:dff_reg_bit_a   rot0      @-185.59,93.97,-178.81,100.22                 ->reg-bc;
cell reg_b[4]:dff_reg_bit_a   rot0      @-197.88,93.97,-191.03,100.22                 ->reg-bc;
cell reg_b[5]:dff_reg_bit_a   rot0      @-210.09,93.97,-203.38,100.22                 ->reg-bc;
cell reg_b[6]:dff_reg_bit_a   rot0      @-222.34,93.97,-215.59,100.19                 ->reg-bc;
cell reg_b[7]:dff_reg_bit_a   rot0      @-234.59,93.97,-227.78,100.25                 ->reg-bc;

# Register WZ
cell inv_z_wr:inv_reg_wr      rot0,flip @-143.19,99.50,-140.38,106.03                                        ->reg-wz;
cell inv_w_wr:inv_reg_wr      rot0      @-143.19,128.53,-140.22,135.03                                       ->reg-wz;
cell reg_z[0]:dff_reg_wz_bit  rot0,flip @-149.97,99.56,-143.16,105.81                                        ->reg-wz;
cell reg_z[1]:dff_reg_wz_bit  rot0,flip @-161.88,99.59,-154.97,105.81                                        ->reg-wz;
cell reg_z[2]:dff_reg_wz_bit  rot0,flip @-173.78,99.63,-166.84,105.88                                        ->reg-wz;
cell reg_z[3]:dff_reg_wz_bit  rot0,flip @-185.69,99.63,-178.72,105.91                                        ->reg-wz;
cell reg_z[4]:dff_reg_wz_bit  rot0,flip @-197.88,99.63,-191.00,105.91                                        ->reg-wz;
cell reg_z[5]:dff_reg_wz_bit  rot0,flip @-210.09,99.63,-203.25,105.91                                        ->reg-wz;
cell reg_z[6]:dff_reg_wz_bit  rot0,flip @-222.41,99.63,-215.47,105.91                                        ->reg-wz;
cell reg_z[7]:dff_reg_wz_bit  rot0,flip @-234.63,99.63,-227.69,105.88                                        ->reg-wz;
...
cell reg_w[0]:dff_reg_wz_bit  rot0      @-149.91,128.78,-143.06,135.00       d@-148.66,130.41                ->reg-wz;
cell reg_w[1]:dff_reg_wz_bit  rot0      @-161.78,128.78,-154.97,135.03       d@-160.53,130.44                ->reg-wz;
cell reg_w[2]:dff_reg_wz_bit  rot0      @-173.66,128.75,-166.88,135.03       d@-172.44,130.44                ->reg-wz;
cell reg_w[3]:dff_reg_wz_bit  rot0      @-185.56,128.81,-178.75,135.06       d@-184.34,130.47                ->reg-wz;
cell reg_w[4]:dff_reg_wz_bit  rot0      @-197.78,128.78,-190.97,135.06       d@-196.59,130.44                ->reg-wz;
cell reg_w[5]:dff_reg_wz_bit  rot0      @-210.00,128.75,-203.25,135.03       d@-208.81,130.41                ->reg-wz;
cell reg_w[6]:dff_reg_wz_bit  rot0      @-222.31,128.78,-215.53,135.09       d@-221.03,130.41                ->reg-wz;
cell reg_w[7]:dff_reg_wz_bit  rot0      @-234.56,128.78,-227.75,135.03       d@-233.34,130.47                ->reg-wz;
cell reg_inv[0]:inv_reg       rot0      @-154.94,128.78,-148.75,141.16                                       ->reg-wz;
cell reg_inv[1]:inv_reg       rot0      @-166.78,128.78,-160.66,141.19                                       ->reg-wz;
cell reg_inv[2]:inv_reg       rot0      @-178.69,128.78,-172.66,141.19                                       ->reg-wz;
cell reg_inv[3]:inv_reg       rot0      @-190.56,128.81,-184.47,141.22                                       ->reg-wz;
cell reg_inv[4]:inv_reg       rot0      @-202.81,128.78,-196.72,141.22                                       ->reg-wz;
cell reg_inv[5]:inv_reg       rot0      @-215.03,128.81,-208.94,141.19                                       ->reg-wz;
cell reg_inv[6]:inv_reg       rot0      @-227.34,128.81,-221.28,141.19                                       ->reg-wz;
cell reg_inv[7]:inv_reg       rot0      @-239.59,128.78,-233.56,141.19                                       ->reg-wz;

# Register SP
cell inv_spl_wr:inv_reg_sp_wr  rot0,flip @-143.19,134.38,-140.25,141.22 ->reg-sp;
cell inv_sph_wr:inv_reg_sp_wr  rot0      @-143.19,153.56,-140.28,160.44 ->reg-sp;
cell reg_spl[0]:dff_reg_sp_bit rot0,flip @-149.94,134.34,-143.06,141.22 ->reg-sp;
cell reg_spl[1]:dff_reg_sp_bit rot0,flip @-161.84,134.38,-154.97,141.16 ->reg-sp;
cell reg_spl[2]:dff_reg_sp_bit rot0,flip @-173.72,134.44,-166.84,141.22 ->reg-sp;
cell reg_spl[3]:dff_reg_sp_bit rot0,flip @-185.59,134.44,-178.75,141.22 ->reg-sp;
cell reg_spl[4]:dff_reg_sp_bit rot0,flip @-197.84,134.41,-191.03,141.22 ->reg-sp;
cell reg_spl[5]:dff_reg_sp_bit rot0,flip @-210.06,134.38,-203.19,141.19 ->reg-sp;
cell reg_spl[6]:dff_reg_sp_bit rot0,flip @-222.34,134.38,-215.47,141.22 ->reg-sp;
cell reg_spl[7]:dff_reg_sp_bit rot0,flip @-234.59,134.41,-227.66,141.22 ->reg-sp;
...
cell reg_sph[0]:dff_reg_sp_bit rot0      @-149.91,153.75,-143.00,160.56 ->reg-sp;
cell reg_sph[1]:dff_reg_sp_bit rot0      @-161.84,153.78,-154.94,160.56 ->reg-sp;
cell reg_sph[2]:dff_reg_sp_bit rot0      @-173.63,153.78,-166.84,160.59 ->reg-sp;
cell reg_sph[3]:dff_reg_sp_bit rot0      @-185.56,153.75,-178.72,160.56 ->reg-sp;
cell reg_sph[4]:dff_reg_sp_bit rot0      @-197.84,153.75,-190.97,160.63 ->reg-sp;
cell reg_sph[5]:dff_reg_sp_bit rot0      @-210.00,153.72,-203.19,160.56 ->reg-sp;
cell reg_sph[6]:dff_reg_sp_bit rot0      @-222.31,153.75,-215.44,160.56 ->reg-sp;
cell reg_sph[7]:dff_reg_sp_bit rot0      @-234.59,153.75,-227.63,160.53 ->reg-sp;
...
cell idu_inv[1]:inv_idu      rot0 @-166.75,179.31,-160.47,187.16 ->idu;
cell idu_inv[2]:inv_idu      rot0 @-178.66,179.34,-172.31,187.16 ->idu;
cell idu_inv[3]:inv_idu      rot0 @-190.53,179.34,-184.25,187.16 ->idu;
cell idu_inv[4]:inv_idu      rot0 @-202.75,179.31,-196.47,187.16 ->idu;
cell idu_inv[5]:inv_idu      rot0 @-215.00,179.31,-208.72,187.19 ->idu;
cell idu_inv[6]:inv_idu      rot0 @-227.28,179.31,-220.94,187.19 ->idu;
cell idu_inv[7]:inv_idu      rot0 @-239.53,179.31,-233.22,187.19 ->idu;
...
cell idu_mux_l[7]:mux_idu_l  rot0 @-233.94,190.22,-227.69,194.81 q@-228.19,194.81 ->idu;
...
cell irq_nand2_nand3[3]:nand2_nand3_irq rot0      @-190.91,201.41,-184.84,210.88 ->irq-ie;
cell irq_nand2_nand3[4]:nand2_nand3_irq rot0      @-203.19,201.41,-197.03,210.84 ->irq-ie;
cell irq_nand2_nand3[5]:nand2_nand3_irq rot0      @-215.44,201.41,-209.38,210.88 ->irq-ie;
cell irq_nand2_nand3[6]:nand2_nand3_irq rot0      @-227.69,201.38,-221.63,210.88 ->irq-ie;
cell irq_nand2_nand3[7]:nand2_nand3_irq rot0      @-239.97,201.38,-233.81,210.91 ->irq-ie;

# Interrupt Handling
cell irq_inv:inv_irq           rot0 @-143.25,210.22,-140.09,229.91                    ->irq;
cell irq_latch[0]:d_latch_irq  rot0 @-155.28,210.28,-143.28,215.44 ena@-155.28,214.00 ->irq;
cell irq_latch[1]:d_latch_irq  rot0 @-167.16,210.31,-155.25,215.41                    ->irq;
cell irq_latch[2]:d_latch_irq  rot0 @-179.06,210.34,-167.16,215.41                    ->irq;
cell irq_latch[3]:d_latch_irq  rot0 @-190.94,210.34,-179.03,215.41                    ->irq;
cell irq_latch[4]:d_latch_irq  rot0 @-203.22,210.31,-191.28,215.41                    ->irq;
cell irq_latch[5]:d_latch_irq  rot0 @-215.47,210.31,-203.56,215.41                    ->irq;
cell irq_latch[6]:d_latch_irq  rot0 @-227.69,210.31,-215.78,215.41                    ->irq;
cell irq_latch[7]:d_latch_irq  rot0 @-239.97,210.31,-228.06,215.44                    ->irq;
