...
cell reg_and:and2_reg rot0 @-236.78,23.50,-232.06,28.09 ->alu-daa;

cell reg_oa1:oa21_reg rot180,flip @-198.91,23.63,-193.41,28.00                   ->alu-daa;
cell reg_oa2:oa21_reg rot0        @-211.03,23.59,-205.41,28.09 in1@-210.31,28.09 ->alu-daa;
...
cell reg_ir_not_we:not_reg_we         rot0 @-143.16,35.14,-140.41,41.62 in@-143.16,36.61 in@-140.84,37.91 ->reg-ir;
...
# Register A
cell reg_a_not_we:not_reg_a_we rot0 @-143.16,43.98,-140.38,50.53 ->reg-a;
...
# Register HL
cell reg_l_not_we:not_reg_l_we       rot0,flip @-143.27,49.84,-140.36,56.14                 ->reg-hl;
cell reg_h_not_we:not_reg_h_e_we     rot0      @-143.25,61.50,-140.38,67.66                 ->reg-hl;
...
# Register DE
cell reg_e_not_we:not_reg_h_e_we     rot0,flip @-143.28,67.13,-140.41,73.34                 ->reg-de;
cell reg_d_not_we:not_reg_we         rot0      @-143.28,78.09,-140.31,84.47                 ->reg-de;
...
# Register BC
cell reg_c_not_we:not_reg_we         rot0,flip @-143.34,83.81,-140.38,90.28                  ->reg-bc;
cell reg_b_not_we:not_reg_b_we       rot0      @-143.16,93.91,-140.38,100.13                 ->reg-bc;
...
# Register WZ
cell reg_z_not_we:not_reg_we           rot0,flip @-143.19,99.50,-140.38,106.03                                        ->reg-wz;
cell reg_w_not_we:not_reg_we           rot0      @-143.19,128.53,-140.22,135.03                                       ->reg-wz;
...
# Register SP
cell reg_spl_not_we:not_reg_sp_we          rot0,flip @-143.19,134.38,-140.25,141.22 ->reg-sp;
cell reg_sph_not_we:not_reg_sp_we          rot0      @-143.19,153.56,-140.28,160.44 ->reg-sp;
...
# Register PC
cell reg_pcl_not_we:not2_reg_pc_we          rot0,flip @-143.13,159.84,-140.75,167.94 ->reg-pc;
cell reg_pch_not_we:not2_reg_pc_we          rot0      @-143.25,179.13,-140.75,187.09 ->reg-pc;
...
cell reg_ie_not_we:not_reg_ie_we           rot0,flip @-143.28,202.97,-140.53,210.84 ->irq-ie;
...
wire daa_lo_gt9:ctl
	...
	"Accumulator low nibble is greater than 9.";
...
wire daa_hi_gt9:ctl
	...
	"Accumulator high nibble is greater than 9.";
...
wire ~ctl_reg_l_we_buf:ctl
	reg_l_not_we.y -> reg_l[0].clk reg_l[1].clk reg_l[2].clk reg_l[3].clk
	                  reg_l[4].clk reg_l[5].clk reg_l[6].clk reg_l[7].clk
	@-141.94,54.22,-141.94,51.22,-239.88,51.34;

wire ~ctl_reg_h_we_buf:ctl
	reg_h_not_we.y -> reg_h[0].clk reg_h[1].clk reg_h[2].clk reg_h[3].clk
	                  reg_h[4].clk reg_h[5].clk reg_h[6].clk reg_h[7].clk
	@-141.91,63.50,-141.91,66.31,-239.94,66.44;

wire ~ctl_reg_e_we_buf:ctl
	reg_e_not_we.y -> reg_e[0].clk reg_e[1].clk reg_e[2].clk reg_e[3].clk
	                  reg_e[4].clk reg_e[5].clk reg_e[6].clk reg_e[7].clk
	@-141.91,71.34,-141.91,68.53,-239.91,68.63;

wire ~ctl_reg_d_we_buf:ctl
	reg_d_not_we.y -> reg_d[0].clk reg_d[1].clk reg_d[2].clk reg_d[3].clk
	                  reg_d[4].clk reg_d[5].clk reg_d[6].clk reg_d[7].clk
	@-141.91,80.25,-141.91,83.09,-239.94,83.19;

wire ~ctl_reg_c_we_buf:ctl
	reg_c_not_we.y -> reg_c[0].clk reg_c[1].clk reg_c[2].clk reg_c[3].clk
	                  reg_c[4].clk reg_c[5].clk reg_c[6].clk reg_c[7].clk
	@-141.91,88.13,-141.91,85.28,-239.88,85.34;

wire ~ctl_reg_b_we_buf:ctl
	reg_b_not_we.y -> reg_b[0].clk reg_b[1].clk reg_b[2].clk reg_b[3].clk
	                  reg_b[4].clk reg_b[5].clk reg_b[6].clk reg_b[7].clk
	@-141.91,95.88,-141.91,98.78,-239.84,98.88;

wire ~ctl_reg_z_we_buf:ctl
	reg_z_not_we.y -> reg_z[0].clk reg_z[1].clk reg_z[2].clk reg_z[3].clk
	                  reg_z[4].clk reg_z[5].clk reg_z[6].clk reg_z[7].clk
	@-141.88,103.81,-141.88,100.94,-239.84,101.03;

wire ~ctl_reg_w_we_buf:ctl
	reg_w_not_we.y -> reg_w[0].clk reg_w[1].clk reg_w[2].clk reg_w[3].clk
	                  reg_w[4].clk reg_w[5].clk reg_w[6].clk reg_w[7].clk
	@-141.88,130.75,-141.88,133.59,-239.84,133.63;

wire ~ctl_reg_sp_we_buf_lo:ctl
	reg_spl_not_we.y -> reg_spl[0].clk reg_spl[1].clk reg_spl[2].clk reg_spl[3].clk
	                    reg_spl[4].clk reg_spl[5].clk reg_spl[6].clk reg_spl[7].clk
	@-141.88,138.66,-141.88,135.78,-239.81,135.80;

wire ~ctl_reg_sp_we_buf_hi:ctl
	reg_sph_not_we.y -> reg_sph[0].clk reg_sph[1].clk reg_sph[2].clk reg_sph[3].clk
	                    reg_sph[4].clk reg_sph[5].clk reg_sph[6].clk reg_sph[7].clk
	@-141.84,156.25,-141.84,159.13,-239.88,159.16;

wire ~ctl_reg_pc_we_buf_lo:ctl
	reg_pcl_not_we.a_y -> reg_pcl[0].clk reg_pcl[1].clk reg_pcl[2].clk reg_pcl[3].clk
	                      reg_pcl[4].clk reg_pcl[5].clk reg_pcl[6].clk reg_pcl[7].clk
	@-142.22,164.66,-142.22,161.88,-239.84,161.88;

wire pcl_~reset:rst
	reg_pcl_not_we.b_y -> reg_pcl[0].~s reg_pcl[1].~s reg_pcl[2].~s reg_pcl[3].~s
	                      reg_pcl[4].~s reg_pcl[5].~s reg_pcl[6].~s reg_pcl[7].~s
	@-239.91,161.31,-141.66,161.31,-141.66,166.41,-239.84,166.44;

wire ~ctl_reg_pc_we_buf_hi:ctl
	reg_pch_not_we.a_y -> reg_pch[0].clk reg_pch[1].clk reg_pch[2].clk reg_pch[3].clk
	                      reg_pch[4].clk reg_pch[5].clk reg_pch[6].clk reg_pch[7].clk
	@-142.19,182.44,-142.19,185.22,-239.84,185.25;

wire pch_~reset:rst
	reg_pch_not_we.b_y -> reg_pch[0].~s reg_pch[1].~s reg_pch[2].~s reg_pch[3].~s
	                      reg_pch[4].~s reg_pch[5].~s reg_pch[6].~s reg_pch[7].~s
	@-239.84,185.78,-141.59,185.74,-141.59,180.63,-239.88,180.69;

wire ie_~we:ctl
	reg_ie_not_we.y -> reg_ie[0].clk reg_ie[1].clk reg_ie[2].clk reg_ie[3].clk
...
wire ie_we:ctl
	irq_and.y -> reg_ie[0].~clk reg_ie[1].~clk reg_ie[2].~clk reg_ie[3].~clk reg_ie[4].~clk reg_ie[5].~clk
	             reg_ie[6].~clk reg_ie[7].~clk reg_ie_not_we.in
...
wire a[0]:adr
	idu[0].buf_a_y port.a[0] -> irq_prio[0].dist_nand_a_in2
...
wire a[8]:adr
	idu[0].buf_b_y port.a[8] -> irq_prio[0].dist_nand_b_in
...
wire a[1]:adr
	idu[1].buf_a_y port.a[1] -> irq_prio[1].dist_nand_a_in
...
wire a[9]:adr
	idu[1].buf_b_y port.a[9] -> irq_prio[1].dist_nand_b_in
...
wire a[2]:adr
	idu[2].buf_a_y port.a[2] -> irq_prio[2].dist_nand_a_in
...
wire a[10]:adr
	idu[2].buf_b_y port.a[10] -> irq_prio[2].dist_nand_b_in
...
wire a[3]:adr
	idu[3].buf_a_y port.a[3] -> irq_prio[3].dist_nand_a_in
...
wire a[11]:adr
	idu[3].buf_b_y port.a[11] -> irq_prio[3].dist_nand_b_in
...
wire a[4]:adr
	idu[4].buf_a_y port.a[4] -> irq_prio[4].dist_nand_a_in
...
wire a[12]:adr
	idu[4].buf_b_y port.a[12] -> irq_prio[4].dist_nand_b_in
...
wire a[5]:adr
	idu[5].buf_a_y port.a[5] -> irq_prio[5].dist_nand_a_in
...
wire a[13]:adr
	idu[5].buf_b_y port.a[13] -> irq_prio[5].dist_nand_b_in
...
wire a[6]:adr
	idu[6].buf_a_y port.a[6] -> irq_prio[6].dist_nand_a_in
...
wire a[14]:adr
	idu[6].buf_b_y port.a[14] -> irq_prio[6].dist_nand_b_in
...
wire a[7]:adr
	idu[7].buf_a_y port.a[7] -> irq_prio[7].dist_nand_a_in
...
wire a[15]:adr
	idu[7].buf_b_y port.a[15] -> irq_prio[7].dist_nand_b_in
...
wire reg_ie[0]:ctl
	reg_ie[0].q -> irq_nand2_nand3[0].a_in1
...
wire ~reg_ie[0]:ctl
	reg_ie[0].~q -> irq_nand2_nand3[0].b_in3
...
wire reg_ie[1]:ctl
	reg_ie[1].q -> irq_nand2_nand3[1].a_in1
...
wire ~reg_ie[1]:ctl
	reg_ie[1].~q -> irq_nand2_nand3[1].b_in3
...
wire reg_ie[2]:ctl
	reg_ie[2].q -> irq_nand2_nand3[2].a_in1
...
wire ~reg_ie[2]:ctl
	reg_ie[2].~q -> irq_nand2_nand3[2].b_in3
...
wire reg_ie[3]:ctl
	reg_ie[3].q -> irq_nand2_nand3[3].a_in1
...
wire ~reg_ie[3]:ctl
	reg_ie[3].~q -> irq_nand2_nand3[3].b_in3
...
wire reg_ie[4]:ctl
	reg_ie[4].q -> irq_nand2_nand3[4].a_in1
...
wire ~reg_ie[4]:ctl
	reg_ie[4].~q -> irq_nand2_nand3[4].b_in3
...
wire reg_ie[5]:ctl
	reg_ie[5].q -> irq_nand2_nand3[5].a_in1
...
wire ~reg_ie[5]:ctl
	reg_ie[5].~q -> irq_nand2_nand3[5].b_in3
...
wire reg_ie[6]:ctl
	reg_ie[6].q -> irq_nand2_nand3[6].a_in1
...
wire ~reg_ie[6]:ctl
	reg_ie[6].~q -> irq_nand2_nand3[6].b_in3
...
wire reg_ie[7]:ctl
	reg_ie[7].q -> irq_nand2_nand3[7].a_in1
...
wire ~reg_ie[7]:ctl
	reg_ie[7].~q -> irq_nand2_nand3[7].b_in3
...
wire inta[6]:ctl
	irq_prio[6].and_a_y -> port.inta[6]
...
wire inta[7]:ctl
	irq_prio[7].and_a_y -> port.inta[7]
