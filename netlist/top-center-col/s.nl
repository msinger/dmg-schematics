...
cell sura:not_x1  rot0,flip @-59.99,131.66,-59.65,133.73   ->bus-adr;
cell syru:muxi    rot0,flip @-60.86,131.64,-59.98,133.72   ->timer;
cell sosy:not_if1 rot0,flip @-61.87,131.66,-60.85,133.70   ->timer;
cell soce:muxi    rot0,flip @-62.73,131.66,-61.88,133.73   ->timer;
cell salu:not_if1 rot0,flip @-63.75,131.66,-62.73,133.71   ->timer;
cell suro:not_if1 rot0,flip @-64.78,131.66,-63.73,133.71   ->timer;
cell sufy:dffr    rot0,flip @-67.69,131.66,-64.77,133.72   ->timer;
cell sala:muxi    rot0,flip @-68.54,131.65,-67.66,133.72   ->timer;
cell sotu:not_if1 rot0,flip @-69.56,131.64,-68.52,133.70   ->timer;
cell supo:not_if1 rot0,flip @-70.59,131.64,-69.55,133.73   ->timer;
cell somu:not_if1 rot0,flip @-71.61,131.66,-70.59,133.71   ->timer;
cell sulo:or2     rot0,flip @-72.30,131.63,-71.59,133.73   ->int;
cell sete:not_if1 rot0,flip @-73.30,131.64,-72.27,133.71   ->timer;
cell soku:not_if1 rot0,flip @-74.34,131.65,-73.30,133.70   ->timer;
cell sabu:dffr    rot0,flip @-77.24,131.64,-74.31,133.70   ->timer;
cell sapu:not_if1 rot0,flip @-78.28,131.63,-77.24,133.71   ->timer;
cell seta:dffr    rot0,flip @-81.18,131.63,-78.25,133.70   ->timer;
cell sawa:not_if1 rot0,flip @-82.21,131.64,-81.16,133.70   ->clocks;
cell subu:dffr    rot0,flip @-85.09,131.63,-82.20,133.70   ->clocks;
cell sola:dffr    rot0,flip @-88.03,131.63,-85.09,133.70   ->clocks;
cell seme:or2     rot0,flip @-88.71,131.61,-88.00,133.69   ->int;
cell sogu:nor2    rot0,flip @-89.21,131.65,-88.68,133.72   ->timer;
cell sepu:not_if1 rot0,flip @-90.25,131.63,-89.20,133.70   ->clocks;
cell samy:dffr    rot0,flip @-93.14,131.63,-90.21,133.70   ->timer;
cell sopu:dffr    rot0,flip @-96.04,131.64,-93.11,133.70   ->timer;
cell sara:nand4   rot0,flip @-96.91,131.65,-96.02,133.70   ->timer;
cell sabo:dffr    rot0,flip @-99.81,131.63,-96.88,133.69   ->timer;
cell supe:not_if1 rot0,flip @-100.84,131.63,-99.79,133.69  ->timer;
cell sora:and4    rot0,flip @-101.86,131.63,-100.80,133.70 ->timer;
cell sapy:not_x1  rot0,flip @-102.22,131.64,-101.84,133.69 ->clocks;
cell sefy:not_x1  rot0,flip @-102.53,131.63,-102.19,133.69 ->serial;
...
wire sara:ctl
	sara.y -> samy.clk sopu.clk sabo.clk
...
wire sora:ctl
	sora.y -> rote.ena ryla.ena supe.ena
...
wire ff00_ff03:dec
	sano.y -> uwam.in4 ucom.in1 urys.in4 ufeg.in1
