...
cell zapa:inv_a rot90 @-109.34,162.83,-107.23,163.16 ->bootrom;
cell zapy:and2  rot90 @-109.33,163.16,-107.24,163.84 ->bootrom;
cell zyro:inv_a rot90 @-109.34,163.84,-107.23,164.19 ->bootrom;
cell zubu:and2  rot90 @-109.34,164.19,-107.24,164.88 ->bootrom;
cell zefu:inv_a rot90 @-109.34,164.87,-107.24,165.22 ->bootrom;
cell zaje:and2  rot90 @-109.33,165.21,-107.26,165.90 ->bootrom;
cell zete:inv_a rot90 @-109.34,165.90,-107.23,166.23 ->bootrom;
...
cell zyba:inv_a rot90 @-109.32,169.66,-107.24,170.01 ->bootrom;
cell zuvy:inv_a rot90 @-109.32,169.99,-107.24,170.34 ->bootrom;
cell zufy:inv_a rot90 @-109.30,170.34,-107.24,170.68 ->bootrom;
cell zera:inv_a rot90 @-109.30,170.67,-107.25,171.02 ->bootrom;
cell zoke:inv_a rot90 @-109.33,171.02,-107.25,171.37 ->bootrom;
cell zabu:inv_a rot90 @-109.32,171.36,-107.24,171.70 ->bootrom;
cell zage:inv_a rot90 @-109.30,171.70,-107.24,172.05 ->bootrom;
cell zyra:inv_a rot90 @-109.34,172.05,-107.26,172.39 ->bootrom;
cell zoku:inv_a rot90 @-109.32,172.38,-107.26,172.73 ->bootrom;
cell zery:inv_a rot90 @-109.34,172.73,-107.23,173.08 ->bootrom;
...
wire bootrom_~{oe}_wl_precharge:ctl
	zoku.q -> boot_rom.~oe boot_rom.wl_pch boot_rom.~wl_ena
...
wire bootrom_oe_~{bl_precharge}:ctl
	zery.q -> boot_rom.oe boot_rom.~bl_pch zoku.in
