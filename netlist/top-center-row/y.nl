...
cell ytob:eco_nand2 rot270     @-83.57,149.28,-81.46,149.79 spare;
cell ymeb:eco_nand2 rot270     @-83.55,149.79,-81.46,150.30 spare;
cell yfal:eco_nand2 rot270     @-83.55,150.30,-81.46,150.82 spare;
cell yxow:eco_nand2 rot270     @-83.55,150.82,-81.46,151.34 spare;
cell ynuj:eco_nand2 rot270     @-83.57,151.33,-81.46,151.84 spare;
cell ytor:eco_nand2 rot270     @-83.56,151.84,-81.46,152.38 spare;
cell yloh:eco_nand2 rot270     @-83.56,152.37,-81.46,152.87 spare;
cell yhes:eco_nand2 rot270     @-83.55,152.88,-81.46,153.39 spare;
cell ykor:eco_nand2 rot270     @-83.56,153.38,-81.45,153.90 spare;
cell ykus:eco_nand2 rot270     @-83.56,153.90,-81.46,154.42 spare;
cell yxaj:eco_nand2 rot270     @-83.55,154.41,-81.45,154.94 spare;
cell ykyt:eco_nand2 rot270     @-83.55,154.93,-81.45,155.45 spare;
cell ydos:eco_nand2 rot270     @-83.56,155.44,-81.47,155.96 spare;
cell yjag:eco_nand2 rot270     @-83.57,155.95,-81.46,156.46 spare;
cell ycaw:eco_nand2 rot270     @-83.56,156.46,-81.47,156.98 spare;
cell ybyw:eco_nand2 rot270     @-83.57,156.97,-81.47,157.48 spare;
cell ynyv:eco_nand2 rot270     @-83.57,157.48,-81.46,157.99 spare;
cell yhyb:dffsr     rot270     @-83.56,157.99,-81.47,161.76 spare;
cell ycym:dffsr     rot270     @-83.57,161.75,-81.48,165.51 spare;
cell yaza:not_x1    rot270     @-84.17,165.87,-82.08,166.21       ->test;
...
cell ycux:not_x1    rot90,flip @-84.17,169.41,-82.07,169.76       ->apu-ch3;
...
cell ydod:not_x1    rot90,flip @-84.20,174.53,-82.09,174.88       ->apu-ch3;
cell ynys:not_x1    rot90,flip @-84.18,174.88,-82.09,175.23       ->apu-ch3;
cell ynur:not_x1    rot90,flip @-84.19,175.22,-82.09,175.57       ->apu-ch3;
cell yzeg:not_x1    rot90,flip @-84.19,175.56,-82.09,175.88       ->apu-ch3;
# column below this row, right to wave ram:
cell ydez:not_x1    rot0,flip  @-94.06,174.25,-93.73,176.32       ->apu-ch3;
cell yrar:not_x1    rot0,flip  @-94.41,174.25,-94.07,176.34       ->apu-ch3;
cell ybor:not_x1    rot0,flip  @-94.74,174.23,-94.41,176.33       ->apu-ch3;
...
wire yaza:ctl yaza.y -> yula.in1; # actual connection not visible
...
wire ~wave_ram_bl_precharge:ctl
	yrar.y -> wave_ram.~bl_pch yhej.in1 ymaw.in1
