...
cell bufa:not_x4 rot270 @-62.20,161.43,-60.12,162.29       ->clocks attrib "sv:W_y=350";
cell byly:not_x6 rot270 @-62.21,162.28,-60.12,163.49       ->clocks attrib "sv:W_y=350";
cell bolo:not_x4 rot270 @-62.20,163.47,-60.13,164.34       ->clocks attrib "sv:W_y=350";
cell byda:not_x6 rot270 @-62.20,164.33,-60.13,165.54       ->clocks attrib "sv:W_y=350";
cell beru:not_x2 rot270 @-62.20,165.53,-60.14,166.05       ->clocks;
cell bapy:nor3   rot270 @-62.21,166.05,-60.13,166.74       ->clocks;
cell bude:not_x4 rot270 @-62.20,166.73,-60.13,167.59       ->clocks attrib "sv:W_y=350";
cell beva:not_x6 rot270 @-62.20,167.59,-60.13,168.79       ->clocks attrib "sv:W_y=350";
cell beko:not_x4 rot270 @-62.20,168.78,-60.15,169.65       ->clocks attrib "sv:W_y=350";
cell bavy:not_x6 rot270 @-62.21,169.64,-60.15,170.84       ->clocks attrib "sv:W_y=350";
...
wire ~clk_1mhz:clk
	...
	attrib "L_extra=-1424"; # subtract overlap with SM83 netlist

wire clk_1mhz:clk
	boga.y -> cpu.clk afer.clk boma.in moba.clk nydu.clk ulur.d1 ukup.clk apug.clk agem.clk acef.clk
	          batu.clk awob.ena
	...
	attrib "L_extra=-1479"; # subtract overlap with SM83 netlist
...
wire ~pch_phase:clk
	buke.y -> cpu.~pch_phase azug.in1 abur.in
	...
	attrib "L_extra=-174"; # subtract overlap with SM83 netlist
...
wire clk_t4:clk
	bufa.y byly.y -> cpu.write_phase bolo.in byda.in anuj.in1 lavo.in3 muzu.in1 decy.in
...
wire ~clk_t4:clk
	bolo.y byda.y -> cpu.~write_phase beja.in1 beja.in2
	...
	attrib "L_extra=-173"; # subtract overlap with SM83 netlist
...
wire data_phase:clk
	bude.y beva.y -> cpu.data_phase beko.in bavy.in dova.in uvyt.in phi.~o
	...
	attrib "L_extra=-171"; # subtract overlap with SM83 netlist

wire ~data_phase:clk
	beko.y bavy.y -> cpu.~data_phase beja.in3 beja.in4
	...
	attrib "L_extra=-170"; # subtract overlap with SM83 netlist
...
wire exec_phase:clk
	bedo.y -> cpu.exec_phase bowa.in leco.in1 axyn.in tuso.in2
	...
	attrib "L_extra=-699"; # subtract overlap with SM83 netlist

wire ~exec_phase:clk
	bowa.y -> cpu.~exec_phase
	...
	attrib "L_extra=-168"; # subtract overlap with SM83 netlist
