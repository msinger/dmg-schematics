...
cell arar:not_if0    rot0 @-164.13,183.47,-163.11,185.52      ->bus-data    attrib "sv:W_y_p=310";
cell ataj:not_if0    rot0 @-165.16,183.45,-164.13,185.52      ->bus-data    attrib "sv:W_y_p=310";
cell asuz:not_if0    rot0 @-166.18,183.48,-165.14,185.51      ->bus-data    attrib "sv:W_y_p=310";
cell ajec:not_if0    rot0 @-167.21,183.47,-166.17,185.51      ->bus-data    attrib "sv:W_y_p=310";
cell afop:not_x2     rot0 @-167.73,183.45,-167.20,185.51      ->bus-data;
cell akaj:not_if0    rot0 @-168.73,183.47,-167.71,185.52      ->bus-data    attrib "sv:W_y_p=310";
cell anoc:not_if0    rot0 @-169.77,183.45,-168.73,185.50      ->bus-data    attrib "sv:W_y_p=310";
...
wire ch2_out[1]:data
	anyv.y -> audio.ch2[1]:codegen ch2_dac.d[1]:-codegen
...
wire ch2_out[0]:data
	anan.y -> audio.ch2[0]:codegen ch2_dac.d[0]:-codegen
...
wire ch2_out[3]:data
	amov.y -> audio.ch2[3]:codegen ch2_dac.d[3]:-codegen
...
wire ch2_out[2]:data
	asog.y -> audio.ch2[2]:codegen ch2_dac.d[2]:-codegen
...
wire ch1_out[3]:data
	aceg.y -> audio.ch1[3]:codegen ch1_dac.d[3]:-codegen
...
wire ch1_out[2]:data
	agof.y -> audio.ch1[2]:codegen ch1_dac.d[2]:-codegen
...
wire ch1_out[0]:data
	amop.y -> audio.ch1[0]:codegen ch1_dac.d[0]:-codegen
...
wire ch1_out[1]:data
	ason.y -> audio.ch1[1]:codegen ch1_dac.d[1]:-codegen
...
wire rmixer0:ctl
	anev.q -> audio.rmixer0:codegen rmix.ena4:-codegen
...
wire rmixer3:ctl
	atuf.q -> audio.rmixer3:codegen rmix.ena1:-codegen
...
wire ~rvolume0:ctl
	apeg.~q -> akod.in audio.~rvolume[0]:codegen rrv.~adj[0]:-codegen
...
wire r_vin_en:ctl
	apos.q -> audio.r_vin_ena:codegen rmix.ena5:-codegen
...
wire ~rvolume2:ctl
	ager.~q -> avud.in audio.~rvolume[2]:codegen rrv.~adj[2]:-codegen
...
wire ch4_out[0]:data
	akof.y -> audio.ch4[0]:codegen ch4_dac.d[0]:-codegen
...
wire ch4_out[2]:data
	apyr.y -> audio.ch4[2]:codegen ch4_dac.d[2]:-codegen
